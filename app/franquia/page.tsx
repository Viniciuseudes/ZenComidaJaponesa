...
const support = [
  {
    ...
    items: ["Técnicas culinárias", "Gestão operacional", "Atendimento ao cliente", "Controle financeiro"],
  },
  {
    title: "Marketing e Publicidade",
    description: "Campanhas nacionais e suporte local",
    items: ["Material publicitário", "Campanhas digitais", "Redes sociais", "Eventos promocionais"],
  },
  {
    title: "Operações",
    description: "Suporte contínuo para excelência operacional",
    items: ["Fornecedores homologados", "Controle de qualidade", "Sistemas de gestão", "Consultoria mensal"],
  },
]

const investmentData = [
  { label: "Investimento Inicial", value: "R$ 350.000", description: "Taxa de franquia + equipamentos" },
  { label: "Capital de Giro", value: "R$ 80.000", description: "Primeiros 3 meses de operação" },
  { label: "Área Mínima", value: "120m²", description: "Localização estratégica" },
  { label: "Royalties", value: "6%", description: "Sobre faturamento bruto mensal" },
]
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90 text-shadow">
                Invista em uma das marcas mais respeitadas da culinária japonesa no Brasil
              </p>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Por que Escolher a Franquia Zen?</h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Junte-se a uma rede de sucesso com mais de 25 anos de tradição na culinária japonesa
            </p>
          </div>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Investimento e Estrutura</h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Transparência total sobre o investimento necessário para sua franquia
            </p>
          </div>
          ...
          <div className="bg-black rounded-2xl p-8 border border-gray-700">
            <h3 className="text-2xl font-bold text-white mb-6 text-center">O que está incluso no investimento:</h3>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Suporte Completo</h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Assista ao vídeo institucional e descubra como construímos uma das maiores redes de culinária japonesa do
              Brasil
            </p>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4">Seja Nosso Próximo Franqueado</h2>
              <p className="text-xl opacity-90">
                Preencha o formulário e nossa equipe entrará em contato para apresentar esta oportunidade única
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 text-gray-900">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Capital Disponível *</label>
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="500-800k">R$ 500.000 - R$ 800.000</option>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Experiência no Setor</label>
                  <div className="relative">
                ...
                >
                  <div className="absolute inset-0 bg-red-600/90"></div>
                  <span className="relative z-10">Quero Ser Franqueado Zen</span>
                </Button>

                <p className="text-xs text-gray-500 text-center">
                  Ao enviar este formulário, você concorda em ser contatado pela equipe Zen sobre oportunidades de
                  franquia.
                </p>
              </form>
            </div>
