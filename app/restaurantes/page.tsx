...
import { MapPin, Clock, Phone, Star, Navigation, X, Mail, Users } from "lucide-react"
...
const restaurants = [
  {
    ...
    features: ["Wi-Fi Gratuito", "Estacionamento", "Cartão de Crédito", "Reservas", "Delivery"],
    capacity: 80,
    googleMapsUrl: "https://maps.google.com/?q=R.+Osório+Borba,+167+-+Piedade,+Recife+-+PE",
  },
  {
    id: 2,
    name: "Zen Espinheiro",
    ...
    features: ["Wi-Fi Gratuito", "Estacionamento Valet", "Cartão de Crédito", "Reservas", "Delivery", "Área VIP"],
    capacity: 120,
    googleMapsUrl: "https://maps.google.com/?q=Rua+da+Hora,+295+-+Espinheiro,+Recife+-+PE",
  },
]

const cities = ["Todas as Cidades", ...Array.from(new Set(restaurants.map((r) => r.city)))]
const states = ["Todos os Estados", ...Array.from(new Set(restaurants.map((r) => r.state)))]
...
export default function RestaurantesPage() {
  ...
  const filteredRestaurants = restaurants.filter((restaurant) => {
    const matchesCity = selectedCity === "Todas as Cidades" || restaurant.city === selectedCity
    const matchesState = selectedState === "Todos os Estados" || restaurant.state === selectedState
    const matchesSearch =
    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-white mb-6">Nossos Restaurantes</h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Encontre a unidade Zen mais próxima de você e desfrute da melhor experiência gastronômica japonesa
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2 text-gray-400">
                      ...
                      <span className="text-sm">{restaurant.capacity} lugares</span>
                    </div>
                    <Button
                      size="sm"
          ...
          {filteredRestaurants.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Nenhum restaurante encontrado</h3>
          ...
          <div className="bg-black rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-700">
            ...
            <div className="relative">
              <div className="h-64 relative">
                <Image
                  src={selectedRestaurant.images[selectedImageIndex] || "/placeholder.svg"}
                ...
                <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm rounded-full px-3 py-1">
                  <div className="flex items-center space-x-1">
                    <Star className="w-4 h-4 text-yellow-400 fill-current" />
                    <span className="text-white text-sm">{selectedRestaurant.rating}</span>
                    <span className="text-gray-300 text-sm">({selectedRestaurant.reviews} avaliações)</span>
                  </div>
                </div>
              </div>
                ...
                {selectedRestaurant.images.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all ${
                      index === selectedImageIndex ? "bg-red-500 scale-125" : "bg-white/50 hover:bg-white/70"
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Left Column */}
                <div>
                  <h2 className="text-3xl font-bold text-white mb-4">{selectedRestaurant.name}</h2>
                  <p className="text-gray-300 mb-6">{selectedRestaurant.description}</p>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-300 mb-3">{selectedRestaurant.fullAddress}</p>
                    <Button
                      onClick={() => handleDirections(selectedRestaurant.googleMapsUrl)}
                      className="text-white shadow-lg relative overflow-hidden"
                      style={{
                        backgroundImage: "url('/sushi-pattern-bg.png')",
                        backgroundSize: "200px 200px",
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-300">{selectedRestaurant.email}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      <p className="text-gray-300">{selectedRestaurant.hours.weekdays}</p>
                      <p className="text-gray-300">{selectedRestaurant.hours.weekend}</p>
                      <p className="text-gray-400 text-sm italic">{selectedRestaurant.hours.special}</p>
                    </div>
                  </div>

                  {/* Features */}
                  <div className="mb-6">
                    <h3 className="text-xl font-semibold text-white mb-3">Comodidades</h3>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-300">{selectedRestaurant.capacity} lugares disponíveis</p>
                  </div>
